...
urlpatterns = [
    ...
    url('^api/sporadics/last_dump',views.api_sporadics_last_dump, name='api_sporadics_last_dump'),
    url('^api/periodics/last_dump',views.api_periodics_last_dump, name='api_periodics_last_dump'),
